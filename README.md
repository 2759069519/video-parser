...
|  |                                            | |
|  |    Platform: Douyin | Kuaishou | Red | Doubao | |
|  |                                            | |
|  +--------------------------------------------+ |
|                                                  |
+--------------------------------------------------+
...
- **[Feat] 新增豆包(Doubao)解析器** — 支持豆包 thread 链接的图片/视频无水印解析
- **[Feat] 图片解析** — 从页面 SSR 数据提取 `image_ori_raw` 无水印原图
- **[Feat] 视频解析** — 提取 vid 调用 `samantha/media/get_play_info` API 获取 1080p 原始视频
- **[Feat] ProxyImage/Download 适配** — 添加豆包域名白名单和 Referer/UA 伪装
